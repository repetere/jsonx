...
| JSONX-COMP-010 | P1 | When a dynamic component has a fetch URL, the system shall render loading output until data resolves, cache transformed data when enabled, render loaded JSONX with fetched resources, and render error output on failure. |
