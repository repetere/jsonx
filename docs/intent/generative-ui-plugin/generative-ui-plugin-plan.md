...
- `docs/intent/generative-ui-plugin/scripts/check-submission-source-docs.mjs` validates the public documentation URLs referenced by the store listing drafts.
