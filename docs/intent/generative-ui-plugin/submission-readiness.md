...
- Validate live GitHub issue tracking with `node docs/intent/generative-ui-plugin/scripts/check-github-issue-tracking.mjs --json` and review `docs/intent/generative-ui-plugin/submission-artifacts/current/github-issue-evidence.json` after regenerating artifacts.
