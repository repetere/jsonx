...
- Use `docs/intent/generative-ui-plugin/submission-artifacts/current/submission-queue.md` as the submitter checklist when opening OpenAI/Codex and Claude Code marketplace submissions and recording receipts.
