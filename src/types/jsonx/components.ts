/**
 */
declare var advancedBinding: any;

/**
 * object of all react components available for JSONX
 */
declare var componentMap: any;
 ...
 */
declare function getBoundedComponents(options: {
    reactComponents: any;
}, boundedComponents: string[]): any;
 ...
 */
declare function getComponentFromLibrary(options: {
 ...
 */
declare function getComponentFromMap(options: {
    jsonx?: any;
    reactComponents?: any;
    componentLibraries?: any;
    logError?: (...params: any[]) => any;
    debug?: boolean;
}): string | ((...params: any[]) => any) | class;
 ...
 * @returns {Function}
 */
declare function getFunctionFromEval(options: {
    body?: string;
    args?: String[];
}): (...params: any[]) => any;
 ...
 */
declare function getReactClassComponent(reactComponent?: any): (...params: any[]) => any;
 ...
 */
declare function getReactFunctionComponent(reactComponent: any, functionBody: string): (...params: any[]) => any;

/**
 */
declare function getReactContext(): void;
