import React, { createContext, useCallback, useRef, useState, useEffect, useContext, isValidElement, cloneElement, createElement as createElement$1, Fragment, Suspense, lazy, useMemo, useReducer, useImperativeHandle, useLayoutEffect, useDebugValue } from 'react';
 ...
 */
//@ts-ignore
let componentMap = Object.assign({ Fragment, Suspense }, ReactDOMElements, window && typeof window === "object" ? window.__jsonx_custom_elements : {});
/**
