...
var jsonx = (() => {
  ...
  var validateField = (field, inputValue, validateAllFieldCriteria, shouldUseNativeValidation) => __async(void 0, null, function* () {
    ...
    if (validate) {
      if (isFunction(validate)) {
        const result = yield validate(inputValue);
        ...
        for (const key in validate) {
          ...
          const validateError = getValidateError(yield validate[key](inputValue), inputRef, key);
          if (validateError) {
  ...
  function createFormControl(props = {}) {
    ...
    const _updateValid = (shouldSkipRender) => __async(this, null, function* () {
      let isValid = false;
      if (_proxyFormState.isValid) {
        isValid = _options.resolver ? isEmptyObject((yield _executeSchema()).errors) : yield executeBuildInValidation(_fields, true);
    ...
    const shouldRenderByError = (name, isValid, error, fieldState) => __async(this, null, function* () {
    ...
    const _executeSchema = (name) => __async(this, null, function* () {
      return _options.resolver ? yield _options.resolver(__spreadValues({}, _formValues), _options.context, getResolverOptions(name || _names.mount, _fields, _options.criteriaMode, _options.shouldUseNativeValidation)) : {};
    });
    ...
    const executeBuildInValidation = (_0, _1, ..._2) => __async(this, [_0, _1, ..._2], function* (fields, shouldOnlyCheckValid, context = {
      valid: true
    }) {
      for (const name in fields) {
        ...
        if (field) {
          ...
          if (fieldReference) {
            const fieldError = yield validateField(field, get(_formValues, fieldReference.name), shouldDisplayAllAssociatedErrors, _options.shouldUseNativeValidation);
          ...
          fieldValue && (yield executeBuildInValidation(fieldValue, shouldOnlyCheckValid, context));
        }
      }
    ...
    const onChange = (event) => __async(this, null, function* () {
      ...
      if (field) {
        ...
        if (_options.resolver) {
          ...
          error = (yield validateField(field, get(_formValues, name), shouldDisplayAllAssociatedErrors, _options.shouldUseNativeValidation))[name];
          isValid = yield _updateValid(true);
        }
    ...
    const trigger = (_0, ..._1) => __async(this, [_0, ..._1], function* (name, options = {}) {
      ...
      if (_options.resolver) {
        ...
        validationResult = (yield Promise.all(fieldNames.map((fieldName) => __async(this, null, function* () {
          const field = get(_fields, fieldName);
          return yield executeBuildInValidation(field && field._f ? { [fieldName]: field } : field);
        })))).every(Boolean);
        !(!validationResult && !_formState.isValid) && _updateValid();
      } else {
        validationResult = isValid = yield executeBuildInValidation(_fields);
      }
    ...
    const handleSubmit = (onValid, onInvalid) => (e2) => __async(this, null, function* () {
      ...
      try {
        if (_options.resolver) {
          const { errors, values } = yield _executeSchema();
          _formState.errors = errors;
          fieldValues = values;
        } else {
          yield executeBuildInValidation(_fields);
        }
  ...
  function simpleJSONXSyntax(simpleJSONX = {}) {
    ...
    try {
      ...
      const jsonx = __spreadProps(__spreadValues({ component }, jsonxprops), { children });
      return jsonx;
    } catch (e2) {
  ...
  function fetchJSON() {
    return __async(this, arguments, function* (path3 = "", options = {}) {
      try {
        const response = yield fetch(path3, options);
  ...
  function FormComponent(props = {}) {
    function FormComponentFunction(componentProps) {
      ...
      const formComponent = __spreadValues({
        component: "div",
        children: "empty form"
      }, props.formComponent);
      formComponent.props = __spreadValues(__spreadValues({}, formComponent.props), componentProps);
      const reactHookForm = useForm(hookFormOptions);
      const context = __spreadValues(__spreadValues({}, this || {}), { reactHookForm });
      if (!context.componentLibraries || !context.componentLibraries.ReactHookForm) {
        context.componentLibraries = __spreadValues(__spreadValues({}, context.componentLibraries), {
          ReactHookForm: {
            Controller,
            ErrorMessage: s
          }
  ...
  function DynamicComponent(props = {}) {
    function DynamicComponentFunction(componentProps) {
      ...
      const jsonx = __spreadValues({}, props.jsonx);
      jsonx.props = __spreadValues(__spreadValues({}, jsonx.props), componentProps);
      const context = this || {};
  ...
  function makeFunctionComponent(func, options) {
    ...
    const functionOptions = __spreadValues({ name: func.name }, options);
  ...
  function getComputedProps(options = {}) {
    ...
    try {
      ...
      if (jsonx.useformregister) {
        const evalJSONX = __spreadProps(__spreadValues({}, jsonx), {
          __dangerouslyEvalAllProps: useFormRegisterHandler
        });
        const contextProps = getEvalProps.call(this, {
          jsonx: evalJSONX
        });
        thiscontext = __spreadValues(__spreadValues({}, thiscontext), contextProps);
      }
  ...
  function getReactElementFromJSONX(jsonx, resources = {}) {
    ...
    try {
      ...
      if (customComponents && Array.isArray(customComponents) && customComponents.length) {
        const cxt = __spreadProps(__spreadValues({}, this), { componentLibraries, reactComponents: components });
        const {
          customComponentLibraries,
          customReactComponents
        } = getReactLibrariesAndComponents2.call(cxt, customComponents);
        componentLibraries = __spreadValues(__spreadValues({}, componentLibraries), customComponentLibraries);
        reactComponents = __spreadValues(__spreadValues({}, reactComponents), customReactComponents);
      }
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=index.web.core-legacy-min.js.map
