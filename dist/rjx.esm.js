...
function getRenderedJSON(componentObject, resources) {
  ...
  try {
    ...
    var props = getRenderedCompProps.call(this, { componentObject: componentObject, resources: resources, renderIndex: renderIndex });
    var children = getComponentObjectChildren.call(this, { componentObject: componentObject, resources: resources, renderIndex: renderIndex });
