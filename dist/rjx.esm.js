...
function getRenderedJSON(componentObject, resources) {
  ...
  try {
    ...
    var props = getComputedProps.call(this, { componentObject: componentObject, resources: resources, renderIndex: renderIndex, componentLibraries: componentLibraries, debug: debug });
