 ...
 */
var componentMap = Object.assign({ Fragment: Fragment, Suspense: Suspense, }, ReactDOMElements, (typeof window === 'object') ? window.__jsonx_custom_elements : {});
/**
...
function getReactClassComponent(reactComponent, options) {
    ...
    if (options.lazy) {
        return lazy(function () { return options.lazy(reactComponent, Object.assign({}, options, { lazy: false, })).then(function (lazyComponent) {
            return {
...
function DynamicComponent(props) {
    ...
    var transformer = useMemo(function () { return getFunctionFromEval(transformFunction); }, [transformFunction]);
    var timeoutFunction = useMemo(function () { return getFunctionFromEval(cacheTimeoutFunction); }, [cacheTimeoutFunction]);
    var renderJSONX = useMemo(function () { return getReactElementFromJSONX.bind(context); }, [context]);
...
function getReactFunctionComponent(reactComponent, functionBody, options) {
    ...
    var functionArgs = [React, useState, useEffect, useContext, useReducer, useCallback, useMemo, useRef, useImperativeHandle, useLayoutEffect, useDebugValue, getReactElementFromJSONX, reactComponent, resources, props,];
