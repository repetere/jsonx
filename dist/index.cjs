...
var componentMap = Object.assign(
  { Fragment: import_react.Fragment, Suspense: import_react.Suspense },
...
function createReactComponentFactory(reactComponentClass) {
  const reactFactory = function jsonxReactComponentFactory(props, ...children) {
    return import_react.default.createElement(reactComponentClass, props, ...children);
  };
...
function DynamicComponent(props = {}) {
  function DynamicComponentFunction(componentProps) {
    ...
    const timeoutFunction = (0, import_react.useMemo)(
    ...
    const loadingError = (0, import_react.useMemo)(
...
function getWindowComponents(options = { jsonx: {} }) {
  ...
  Object.keys(windowComponents).forEach((key) => {
    ...
    if (typeof windowComponents[key] === "string" && windowComponents[key].indexOf(windowFuncPrefix) !== -1 && typeof window2.__jsonx_custom_elements[windowKEY] === "function") {
      ...
      allProps[key] = import_react2.default.createElement(
...
function outputHTML(config = { jsonx: { component: "" } }) {
  ...
  return this && this.useJSON ? import_server.default.renderToString(
  ...
  ) : import_server.default.renderToString(
